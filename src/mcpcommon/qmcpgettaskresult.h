...
#ifndef QMCPGETTASKRESULT_H
#define QMCPGETTASKRESULT_H
...
/*! \class QMcpGetTaskResult
    \inmodule QtMcpCommon
    \brief The response to a tasks/get request.
...
*/
class Q_MCPCOMMON_EXPORT QMcpGetTaskResult : public QMcpResult
{
    Q_GADGET

    /*!
        \property QMcpGetTaskResult::createdAt
    ...
    */
    ...
    /*!
        \property QMcpGetTaskResult::lastUpdatedAt
    ...
    */
    ...
    /*!
        \property QMcpGetTaskResult::pollInterval
...
public:
    QMcpGetTaskResult() : QMcpResult(new Private) {}
...
Q_DECLARE_SHARED(QMcpGetTaskResult)

QT_END_NAMESPACE

#endif // QMCPGETTASKRESULT_H

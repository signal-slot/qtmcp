...
#ifndef QMCPTASKSTATUSNOTIFICATIONPARAMS_H
#define QMCPTASKSTATUSNOTIFICATIONPARAMS_H
...
/*! \class QMcpTaskStatusNotificationParams
    \inmodule QtMcpCommon
    \brief Parameters for a notifications/tasks/status notification.

    The schema defines this type as an allOf of NotificationParams and Task.
    Gadgets support single inheritance only, so the Task members are repeated
    here instead of being aggregated; they sit next to the NotificationParams
    members in the JSON object either way.

    \since MCP 2025-11-25
*/
class Q_MCPCOMMON_EXPORT QMcpTaskStatusNotificationParams : public QMcpNotificationParams
{
    Q_GADGET

    /*!
        \property QMcpTaskStatusNotificationParams::createdAt
    ...
    */
    ...
    /*!
        \property QMcpTaskStatusNotificationParams::lastUpdatedAt
    ...
    */
    ...
    /*!
        \property QMcpTaskStatusNotificationParams::pollInterval
    ...
    */
    ...
    /*!
        \property QMcpTaskStatusNotificationParams::taskId
        \brief The task identifier.
    */
    Q_PROPERTY(QString taskId READ taskId WRITE setTaskId REQUIRED)

    /*!
        \property QMcpTaskStatusNotificationParams::ttl
...
public:
    QMcpTaskStatusNotificationParams() : QMcpNotificationParams(new Private) {}
...
Q_DECLARE_SHARED(QMcpTaskStatusNotificationParams)

QT_END_NAMESPACE

#endif // QMCPTASKSTATUSNOTIFICATIONPARAMS_H

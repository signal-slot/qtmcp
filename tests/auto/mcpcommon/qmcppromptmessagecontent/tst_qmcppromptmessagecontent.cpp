...
class tst_QMcpPromptMessageContent : public QObject
{
    Q_OBJECT
...
void tst_QMcpPromptMessageContent::defaultValues()
{
...
void tst_QMcpPromptMessageContent::textContent()
{
    // Create text content
    QMcpTextContent textContent;
    textContent.setText("Hello, world!");
    
    // Set it in the prompt message content
    QMcpPromptMessageContent content;
...
void tst_QMcpPromptMessageContent::imageContent()
{
...
void tst_QMcpPromptMessageContent::audioContent()
{
...
void tst_QMcpPromptMessageContent::embeddedResource()
{
...
void tst_QMcpPromptMessageContent::copyConstructor()
{
    // Create content with text
    QMcpPromptMessageContent original;
    QMcpTextContent textContent;
    textContent.setText("Hello, world!");
    original.setTextContent(textContent);
    
    // Test copy constructor
    QMcpPromptMessageContent copy(original);
...
void tst_QMcpPromptMessageContent::assignmentOperator()
{
    ...
    QMcpPromptMessageContent assigned;
    assigned = original;
...
void tst_QMcpPromptMessageContent::constructors()
{
    // Test constructor with text content
    QMcpTextContent textContent;
    textContent.setText("Hello, world!");
    QMcpPromptMessageContent textResult(textContent);
    ...
    imageContent.setData(QByteArray("image data"));
    imageContent.setMimeType("image/png");
    QMcpPromptMessageContent imageResult(imageContent);
    ...
    audioContent.setData(QByteArray("audio data"));
    audioContent.setMimeType("audio/mp3");
    QMcpPromptMessageContent audioResult(audioContent);
    ...
    resource.setTextResourceContents(textResourceContents);
    embeddedResource.setResource(resource);
    QMcpPromptMessageContent resourceResult(embeddedResource);
...
QTEST_MAIN(tst_QMcpPromptMessageContent)
#include "tst_qmcppromptmessagecontent.moc"